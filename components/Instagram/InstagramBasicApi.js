...
export async function getInstagramPictures(access_token, image_count) {
  ...
  if (mediaError) {
    ...
    //TODO not sending error back to frontend so the user can't see it. Better solution
    // is to send it back but Instagram PropTypes must be changed in Instagram comp.
    return [];
  }
